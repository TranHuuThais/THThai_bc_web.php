...
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li><a href="../product/index.php"><i class='bx bxs-chart icon'></i> Product</a></li>
            <li><a href="./index.php"><i class='bx bxs-widget icon'></i> Categories</a></li>
    ...
    <script src="../public/js/admin_Category.js"></script>
